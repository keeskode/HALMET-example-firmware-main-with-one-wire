...
// Zo heb ik het berekend. Meeste alternators hebben 6 poles. Pulley ratio verschilt, maar lijkt tussen 2 en 2.5 te zitten.
/*
Determine the alternator's rotational speed relative to the engine:

Alternator RPM = Engine RPM × Pulley Ratio
Alternator RPM = Engine RPM × 2.166
Calculate the number of pulses per engine revolution:

Pulses per Engine Revolution = Alternator Pulses per Revolution × Pulley Ratio
Pulses per Engine Revolution = 6 × 2.166 ≈ 13
*/

const float kDefaultFrequencyScale = 1 / 13.;
